...
import { Activity, FileCode, Globe, AlertCircle, Gauge, ExternalLink, LayoutList, FileSearch, Brain, FileText } from 'lucide-react';
...
import SEOFilesManager from './SEOFilesManager';
...
const Dashboard: React.FC<DashboardProps> = ({ report, loading, onReset, aiStatus, aiResult, onRequestAi, onOpenPerformance, onSelectReport }) => {
    const [activeTab, setActiveTab] = useState<'SINGLE' | 'SITE' | 'AI' | 'SEO_FILES'>('SINGLE');
                ...
                <div className="animate-fade-in flex flex-col gap-6">
                    ...
                    <div className="flex gap-6 border-b border-[#333] overflow-x-auto">
                        <button
                            ...
                            className={`pb-3 px-2 flex items-center gap-2 text-sm font-medium transition-colors relative whitespace-nowrap ${activeTab === 'SINGLE' ? 'text-white' : 'text-gray-500 hover:text-gray-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`pb-3 px-2 flex items-center gap-2 text-sm font-medium transition-colors relative whitespace-nowrap ${activeTab === 'SITE' ? 'text-white' : 'text-gray-500 hover:text-gray-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`pb-3 px-2 flex items-center gap-2 text-sm font-medium transition-colors relative whitespace-nowrap ${activeTab === 'AI' ? 'text-red-400' : 'text-gray-500 hover:text-gray-300'
                                }`}
                        >
                        ...
                        <button
                            onClick={() => setActiveTab('SEO_FILES')}
                            className={`pb-3 px-2 flex items-center gap-2 text-sm font-medium transition-colors relative whitespace-nowrap ${activeTab === 'SEO_FILES' ? 'text-white' : 'text-gray-500 hover:text-gray-300'
                                }`}
                        >
                            <FileText size={16} />
                            <span className="text-sm">SEO Files</span>
                            {activeTab === 'SEO_FILES' && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-red-500"></div>}
                        </button>
                    </div>
